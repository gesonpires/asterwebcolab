...
const MathFoundationsView = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Fundamentos Matemáticos</h1>
        ...
        {mathTopics.map(topic => (
          ...
          >
            ...
            {topic.prerequisites.length > 0 && (
              <div className="mb-4">
                <h3 className="text-sm font-semibold mb-2">Pré-requisitos:</h3>
...
export default MathFoundationsView;
